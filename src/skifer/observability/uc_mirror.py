...
def mirror_certification(backend, table_fqn: str, certification: Certification, owner: str | None = None) -> UcSyncResult:
    """Write only allowlisted, coarse metadata; permission errors stay local."""
    tags = {"skifer_owner": owner, "contract_version": certification.contract_version,
